  ...
  return (
    ...
    >
      ...
      <div className="container-x relative z-10 -mt-20 flex flex-col items-center text-center w-full sm:-mt-28 md:-mt-32">
        ...
        <p className="mt-3 max-w-2xl text-lg font-medium leading-relaxed text-cream-50 drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)] md:text-xl animate-fade-up [animation-delay:200ms] opacity-0">
